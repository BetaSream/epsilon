...
public class Const {
    ...
    public final static String IMG_PATH = "http://localhost:8089/img";
    public final static String DEFAULT_IMG = "http://localhost:8089/img/2021/12/400bba2995ec46fc97249cece09f9ca4.jpg";
